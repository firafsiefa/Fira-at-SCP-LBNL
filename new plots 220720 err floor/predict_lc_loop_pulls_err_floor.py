...
def get_lightcurve1(sn):
    ...
    for band_name, band in generate.SNF_BANDS.items():
        ...
        ax2.scatter(phases, residuals, label='SNf'+band_name+' (residuals)')
        ax3.scatter(phases, (residuals/obs_err_floor), label='SNf'+band_name+' (pulls)')
    ...
    yo = '/Users/FIRA FATMASIEFA/nn_twins_embedding/new plots 220720 err floor/'+str(sn)+'.jpg'
    plt.savefig(yo)
    plt.close()
